...
<script>
	...
	$.post("/xuly_taikhoan/xuly_themgiohang.php", {id: id},
			...
			if (dulieu.thanhcong == 1) {
				setTimeout(function () {
					window.location.assign('/trochoi/lien-quan-mobile');
				}, 500);
			}				
		}, "json");		    
	}
...
<?php
    ...
    $tong_taikhoan = mysqli_num_rows(mysqli_query($ketnoi, "SELECT * FROM baidang WHERE loai_taikhoan = 'LQM' AND `trangthai` = 'chuaban' $dulieu_maso $dulieu_taikhoan_vip $dulieu_gia $dulieu_xephang"));
...
$ketnoi_taikhoan = mysqli_query($ketnoi, "SELECT * FROM `baidang` WHERE loai_taikhoan = 'LQM' AND `trangthai` = 'chuaban' $dulieu_maso $dulieu_taikhoan_vip $dulieu_gia $dulieu_xephang $dulieu_sapxepgia LIMIT {$phantrang->ketthuc_phantrang()["start"]}, {$phantrang->ketthuc_phantrang()["limit"]}");
?>
        <div class="row">
            <?php
            if ($tong_taikhoan == 0){
            ...
            <div class="col-sm-6 col-md-3">
                <div class="card card-product">
                    <div class="card-image">
                        <a href="/taikhoan/lien-quan-mobile-ma-so-<?php echo $dulieu_taikhoan['id']; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-title">
                            <a href="/taikhoan/lien-quan-mobile-ma-so-<?php echo $dulieu_taikhoan['id']; ?>" class="card-link"><?php echo $loai_taikhoan; ?> MS<?php echo $dulieu_taikhoan['id']; ?></a>
                        </h4>
                        ...
                        <li style="color:#333;">Xếp hạng: <b><?php echo xephanglienquan($dulieu_taikhoan['xephang']); ?></b></li>
                        <li style="color:#333;">Bảng ngọc: <b><?php echo $dulieu_taikhoan['bangngoc']; ?></b></li>
                        </ul>


                        <div class="card-footer" style="padding-top:20px;">
                                <a href="/taikhoan/lien-quan-mobile-ma-so-<?php echo $dulieu_taikhoan['id']; ?>" class="btn btn-primary btn-outline-primary" style="color: #2ca8ff;border: 1px solid #2ca8ff;"><?php echo number_format($dulieu_taikhoan['gia']); ?> VNĐ</a>
...
<?php echo $phantrang->phantrang_lienquan(); ?>