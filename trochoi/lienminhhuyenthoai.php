...
$tieudetrang = 'LIÊN MINH HUYỀN THOẠI';
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto">
                    <h2 class="title" style="color:white;">LIÊN MINH HUYỀN THOẠI</h2>
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
    <div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-2">
                <div class="form-group">
                    <button class="btn-round btn btn-outline-info" type="button" onclick="boloc_lienminh();">Tìm kiếm</button>
                </div>
            </div>
            <div class="col-sm-6 col-lg-2">
                <div class="form-group">
                    <button class="btn-round btn btn-outline-danger" type="button" onclick="xoa_boloc_lienminh();">Xóa tìm kiếm</button>
                </div>
            </div>   
...
<div class="section related-products" data-background-color="white">
    <div class="container">
                    <div style="display: block;" class="tatca_taikhoan_lienminh"></div>
...
<script>
    function danhsach_lienminh() {
        $(".tatca_taikhoan_lienminh").hide();
        $("#taidulieu").show();
        $.post("/trochoi/danhmuc/lienminh.php", {
                page: page,
                maso: maso,
                gia: gia,
                sapxepgia: sapxepgia,                
            ...
            .done(function(data) {
                $(".tatca_taikhoan_lienminh").html('');
                $('.tatca_taikhoan_lienminh').empty().append(data);
                $("#taidulieu").hide();
                $(".tatca_taikhoan_lienminh").show();
            });
    }

    function boloc_lienminh() {
        maso = $("#maso").val();
        gia = $("#gia").val();
