...
$tieudetrang = 'Đăng kí tài khoản - '.$hethong['mota_logo'];
if($taikhoan_id){
    header('location: /');
}
?>
...
$(document).ready(function () {
			$("#xuly_dangki").ajaxForm({
					dataType: 'json',
					url: '/xuly_taikhoan/xuly_dangki.php',
					success: function (dulieu) {
						if (dulieu.kiemtra == 0) {
							...
							setTimeout(function () {
								window.location.assign('/taikhoan/dangnhap');
							}, 1000);
						} else if(dulieu.kiemtra == 2) {
							swal({
							title: dulieu.tieude,
							text: dulieu.noidung,
							icon: dulieu.icon,
            ...
            <div class="container">
                <div class="col-md-5 ml-auto mr-auto">
                    <div class="card card-login card-plain">
                        <form class="form" action="#" method="post" id="xuly_dangki">
                            ...
                            <div class="card-body" style="margin-bottom: -60px;">
                              ...
                              <div class="input-group no-border input-lg">
                                <div class="input-group-prepend">
                                  <span class="input-group-text"><i class="now-ui-icons travel_info"></i></span>
                                </div>
                              ...
                              <div class="input-group no-border input-lg">
                                ...
                                <input type="password" name="matkhau2" class="form-control" placeholder="Mật khẩu cấp 2">
                              </div>
                            </div>                            
                            <div class="card-footer text-center">
                                <button type="submit" class="btn btn-primary btn-round btn-lg btn-block">Đăng ký</button>
                            </div>
                            <div class="pull-left">
                                <h6><a href="/taikhoan/dangnhap" class="link footer-link">Đăng nhập tài khoản</a></h6>
                            </div>

                            <div class="pull-right">
                                <h6><a href="/taikhoan/laymatkhau" class="link footer-link">Quên mật khẩu?</a></h6>
                            </div>
                        </form>
                    </div>
                </div>
