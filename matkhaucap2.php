...
$tieudetrang = 'Cập nhật mật khẩu cấp 2 - '.$hethong['mota_logo'];
if(!$taikhoan_id){
    header('location: /');
}elseif($dulieu_taikhoan['matkhau2'] != ''){
    header('location: /');
}
?>
<!DOCTYPE html>
...
$(document).ready(function () {
			$("#xuly_matkhaucap2").ajaxForm({
					dataType: 'json',
					url: '/xuly_taikhoan/xuly_matkhaucap2.php',
            ...
            <div class="container">
                <div class="col-md-5 ml-auto mr-auto">
                    <div class="card card-login card-plain">
                        <form class="form" action="#" method="post" id="xuly_matkhaucap2">
                            ...
                            <div class="card-body" style="margin-bottom: -60px;">
                              <div class="input-group no-border input-lg">
                                ...
                                <input type="password" name="matkhau2" class="form-control" placeholder="Nhập mật khẩu cấp 2">
                              </div>
                            </div>
