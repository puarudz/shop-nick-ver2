...
$tieudetrang = 'Đăng nhập tài khoản - '.$hethong['mota_logo'];
if($taikhoan_id){
    header('location: /');
}
?>
...
$(document).ready(function () {
			$("#xuly_dangnhap").ajaxForm({
					dataType: 'json',
					url: '/xuly_taikhoan/xuly_dangnhap.php',
            ...
            <div class="container">
                <div class="col-md-5 ml-auto mr-auto">
                    <div class="card card-login card-plain">
                        <form class="form" action="#" method="post" id="xuly_dangnhap">
                            ...
                            <div class="card-footer text-center">
                                <button type="submit" class="btn btn-primary btn-round btn-lg btn-block">Đăng nhập</button>
                                <a href="/taikhoan/facebook/" class="btn btn-info btn-round btn-lg btn-block">Đăng nhập Facebook</a>                                
                            </div>
                            <div class="pull-left">
