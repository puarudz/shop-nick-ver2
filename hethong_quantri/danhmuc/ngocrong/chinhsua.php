...
$(document).ready(function () {
	$("#chinhsua-ngocrong").ajaxForm({
		dataType: 'json',
		url: '/xuly_taikhoan/ngocrong/chinhsua.php',
        ...
        <h3 class="block-title">SỬA NGỌC RỒNG ONLINE MS <?php echo $id; ?></h3>
    <br/>
            ...
            <div class="col-md-12">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-star"></i></span>
                     ...
                     <?php
                        for($i = 1; $i < 4; $i++){
                        echo '<option value="'.$i.'" '.($dulieu['nro_hanhtinh']==$i ? 'selected="selected"': '').'>'.hanhtinh_ngocrong($i).'</option>';
                        }
                    ?>
                        </select>
                </div>
            ...
            <div class="col-md-12">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-star"></i></span>
                     ...
                     <?php
                        for($i = 1; $i < 8; $i++){
                        echo '<option value="'.$i.'" '.($dulieu['nro_maychu']==$i ? 'selected="selected"': '').'>'.maychu_ngocrong($i).'</option>';
                        }
                    ?>
                        </select>
                </div>
            ...
            <div class="col-md-12">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-star"></i></span>
                     ...
                     <?php
                        for($i = 1; $i < 3; $i++){
                        echo '<option value="'.$i.'" '.($dulieu['nro_dangky']==$i ? 'selected="selected"': '').'>'.dangky_ngocrong($i).'</option>';
                        }
                    ?>
                        </select>
                </div>
            ...
            <div class="col-md-12">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-star"></i></span>
                     ...
                     <?php
                        for($i = 1; $i < 3; $i++){
                        echo '<option value="'.$i.'" '.($dulieu['nro_bongtai']==$i ? 'selected="selected"': '').'>'.bongtai_ngocrong($i).'</option>';
                        }
                    ?>
                        </select>
                </div>
            ...
            <div class="col-md-12">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-star"></i></span>
                     ...
                     <?php
                        for($i = 1; $i < 3; $i++){
                        echo '<option value="'.$i.'" '.($dulieu['nro_sosinhcode']==$i ? 'selected="selected"': '').'>'.sosinhcode_ngocrong($i).'</option>';
                        }
                    ?>
                        </select>
                </div>
