...
$(document).ready(function () {
	$("#chinhsua-lmht").ajaxForm({
		dataType: 'json',
		url: '/xuly_taikhoan/lienminh/chinhsua.php',
        ...
        <h3 class="block-title">SỬA LIÊN MINH HUYỀN THOẠI MS <?php echo $id; ?></h3>
    <br/>
    <form action="" method="post" class="form-horizontal" id="chinhsua-lmht">
            ...
            <div class="col-md-12">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-star"></i></span>
                     ...
                     <?php
                        for($i = 1; $i < 29; $i++){
                        echo '<option value="'.$i.'" '.($dulieu['xephang']==$i ? 'selected="selected"': '').'>'.xephanglienminh($i).'</option>';
                        }
                    ?>
                        </select>
                </div>
            ...
            <div class="col-md-12">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-star"></i></span>
                     ...
                     <?php
                        for($i = 1; $i < 10; $i++){
                        echo '<option value="'.$i.'" '.($dulieu['khung']==$i ? 'selected="selected"': '').'>'.khung_xephanglienminh($i).'</option>';
                        }
                    ?>
                        </select>
                </div>
